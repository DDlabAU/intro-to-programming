...
*Eksempel på brug af if-sætninger: sketch kaldet IfElse.pde*
_*Quick task: Få ellipsen i eksempel IfElse til at ”bounce” mod alle siderne*_
...
*Eksempel på brug af if-sætninger og boolean: sketch kaldet ifElseAndBool.pde*
...
_*Quick task: Lav din egen boolean variabel i programmet fra sidste øvelse, der ændrer noget i programmet når variablen er lig true (med et while loop eller med en if-sætning).*_
...
_*Qucik task: Lav et nyt program med et for loop der er begrænset af længden af et array.*_
