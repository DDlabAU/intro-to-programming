...
//ligeledes hvis det skal gælde når on=false kan det skrives således
If(!on) {
  //…
}
```
...
```processing
//en array der kan indeholde 5 heltal. (SKAL initialiseres inden for setup() eller draw())
int [ ] myArray;
